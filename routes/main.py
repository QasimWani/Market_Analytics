...
def search_Parent_BING(QUERY):
    ...
    return summaries, title_pages,links_pages, LDA_mult
...
"""
def main(QUERY):
    summaries, title_pages,links_pages, LDA_mult = search_Parent_BING(QUERY)
    print(json.dumps([summaries, title_pages,links_pages, LDA_mult]))
